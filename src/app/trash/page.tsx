            ...
            <main className="p-4 md:p-6">
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        <IoTrash size={32} color="#FF3B30" />
                        <h1 className="text-2xl font-bold" style={{ color: colors.text }}>
                            Trash
                        </h1>
                        <span
                            className="px-3 py-1 rounded-full text-sm font-semibold"
                            style={{ backgroundColor: "#FF3B30" + "20", color: "#FF3B30" }}
                        >
                            {tasks.length}
                        </span>
                    </div>
                    ...
                    {tasks.length === 0 ? (
                        <div className="text-center py-16">
                            <IoTrash size={64} color={colors.textSecondary} className="mx-auto mb-4 opacity-50" />
                        ...
                        <div className="space-y-3">
                            {tasks.map((task) => (
                                <div
                                    key={task.id}
                                    className="flex items-center justify-between p-4 rounded-xl border opacity-75"
                                    style={{
                                ...
                                >
                                    <div>
                                        <h3 className="font-semibold line-through" style={{ color: colors.text }}>
                                            {task.title}
                                        </h3>
                                        {task.deletedAt && (
